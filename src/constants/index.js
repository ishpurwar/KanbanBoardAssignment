...
export const UserIcon = () => (
  ...
  >
    ...
    >
      ...
      <path d="M20 21a8 8 0 10-16 0" strokeWidth="2"></path>
    </svg>
  </div>
);
export const ColumnIcon = ({ title, groupBy }) => {
  if (groupBy === "status" && StatusIcons[title]) {
    const Icon = StatusIcons[title];
    return <Icon />;
  }

  if (groupBy === "priority" && PriorityIcons[title]) {
